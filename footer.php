        ...
        <div class="p-footer__wrap">
          ...
          <div class="p-footer__nav">
            <ul>
              ...
              <li>
                <a class="animsition-link" href=" <?php echo esc_url( home_url('/price')); ?>"><span class="c-txt-sm">料金体系</span></a>
              </li>
              <li>
      ...
      <nav class="mobile-menu__nav">
        ...
        <div class="contact-btn">
          <ul class="contact-btn-list">
            ...
            <li class="contact-btn-item">
              <a target="_blank" href=" <?php echo esc_url( home_url('https://beauty.hotpepper.jp/')); ?>">
