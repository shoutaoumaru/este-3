...
<head>
  ...
  <title>お問い合わせフォーム | エステテンプレート1</title>
  <?php get_header(); ?>
</head>
  ...
  <div class="superwrapper animsition c-contact">
    ...
    <section class="c-topview">
      ...
      <div class="c-container">
        ...
        <p class="c-txt-sm">
          初めての方、運動が苦手な方、<br />まずはお気軽に体験してみませんか？<br />経験豊富なトレーナーが丁寧にご案内いたします。
        </p>
      </div>
    </section>
    <!-- /.c-topview -->
        ...
        <div role="form" class="wpcf7" id="wpcf7-f13-o1" lang="ja" dir="ltr">
          ...
          <form action="/contact/#wpcf7-f13-o1" method="post" class="wpcf7-form init" novalidate="novalidate"
              ...
              <dd>
                <span class="wpcf7-form-control-wrap your-name"><input type="text" name="your-name" value="" size="40"
                    class="
                      ...
                      " aria-required="true" aria-invalid="false" placeholder="田中　太郎" /></span>
              </dd>
            </dl>
            <dl class="ct-mail">
            ...
            <dl class="ct-tel">
              ...
              <dd>
                <span class="wpcf7-form-control-wrap tel-42"><input type="tel" name="tel-42" value="" size="40" class="
                        wpcf7-form-control
                        wpcf7-text
                        wpcf7-tel
                        wpcf7-validates-as-required
            ...
            <dl class="ct-request">
              ...
              <dd>
                <span class="wpcf7-form-control-wrap menu-802"><select name="menu-802" class="
                        wpcf7-form-control
                        wpcf7-select
                        wpcf7-validates-as-required
            ...
            <div class="ct-flex">
              <dl class="ct-sex">
                <dt class="must">性別</dt>
                <dd>
                  <span class="wpcf7-form-control-wrap menu-72"><select name="menu-72" class="
                          wpcf7-form-control
                          wpcf7-select
                          wpcf7-validates-as-required
                        " aria-required="true" aria-invalid="false">
            ...
            <div class="ct-flex">
              <dl class="ct-date">
                ...
                <dd>
                  <span class="wpcf7-form-control-wrap date-487"><input type="date" name="date-487" value="" class="
            ...
            <p class="privacy">
              <span class="wpcf7-form-control-wrap acceptance-377"><span
                ...
                class="ms-1">プライバシーポリシー</a>に同意する
            </p>
            <div class="submit-btn">
              <input type="submit" value="送信" class="wpcf7-form-control has-spinner wpcf7-submit" disabled="" /><span
